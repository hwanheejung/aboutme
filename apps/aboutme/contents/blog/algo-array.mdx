...
<Section.Header title="There's no Array in Python?" />
...
<Section.Header
  title="Theoretical vs. Actual Time Complexity"
  type="secondary"
/>
...
<Section.Header title="Amortized Analysis" type="secondary" />
...
<Section.Header title="Conclusion" />
