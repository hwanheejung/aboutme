...
- Two-month program per class, two classes per year
- Previous class manages club operations, recruitment, and mentoring
...
- Decreased disputes by over **80%** compared to the previous class
