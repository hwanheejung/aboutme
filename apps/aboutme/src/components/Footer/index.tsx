...
const Footer = () => {
  return (
    <>
      <div className="mx-5 mt-20 grid grid-cols-2 rounded-xl border border-primary/20 px-10 py-10">
      ...
      <div className="flex justify-between px-10 py-5 text-primary/60">
